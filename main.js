...
const portfolioProjectDetails = {
	moeskops: {
		...
		tags: ["Klantwebsite", "Live website", "Gevelwerken", "Business Website"],
		details: [
	...
	agv: {
		...
		tags: ["Klantwebsite", "Live website", "Gevelrenovatie", "Business Website"],
		details: [
			["Projecttype", "Klantproject"],
			...
			["Oplossing", "Een zakelijke website met sterke eerste indruk, diensten, realisaties, werkwijze en offerteflow."],
